...
const StaffAttendanceList = ({ data, currentPage, itemsPerPage }) => {
  ...
  return (
    <div className="mt-3 shadow-md rounded-xl text-xs sm:text-sm border-2 border-indigo-300 overflow-x-auto no-scrollbar font-poppins text-xs sm:tex-sm">
